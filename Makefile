...
mx6dl_rex_config                        \
mx6dl_rex_android_config                \
mx6q_rex_config                         \
mx6q_rex_android_config                 \
mx6q_rex_iram_config      : unconfig
	@[ -z "$(findstring iram_,$@)" ] || \
		{ echo "TEXT_BASE = 0x00907000" >$(obj)board/freescale/mx6q_rex/config.tmp ; \
		  echo "... with iram configuration" ; \
		}
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx6q_rex freescale mx6
