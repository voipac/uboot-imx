...
#define CONFIG_REX_DEFAULT_ARCH_PREFIX      CONFIG_MODULE_TYPE_PREFIX
#define CONFIG_REX_DEFAULT_ARCH_POSTFIX     CONFIG_MODULE_TYPE_POSTFIX

#if defined(CONFIG_DDR_SIZE)
#define CONFIG_REX_PHYS_SDRAM_SIZE          CONFIG_DDR_SIZE
#else
...
#define CONFIG_ENV_DEFAULT_UBT_FILE         "u-boot-" CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex" CONFIG_REX_DEFAULT_ARCH_POSTFIX ".imx"
#define CONFIG_ENV_DEFAULT_IMG_FILE         "zImage-" CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex" CONFIG_REX_DEFAULT_ARCH_POSTFIX
#define CONFIG_ENV_DEFAULT_FDT_FILE                   CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex" CONFIG_REX_DEFAULT_ARCH_POSTFIX ".dtb"
#define CONFIG_ENV_DEFAULT_SCR_FILE         "boot-"   CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex" CONFIG_REX_DEFAULT_ARCH_POSTFIX ".scr"
