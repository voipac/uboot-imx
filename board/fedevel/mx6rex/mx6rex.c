...
#define GPIO_USDHC2_CD   IMX_GPIO_NR(2, 2)
...
static const struct boot_mode board_boot_modes[] = {
    ...
    {"mmc1", MAKE_CFGVAL(0x40, 0x28, 0x00, 0x00)}, // SD2
    {NULL,   0},
};
#endif
...
#define I2C_PCA9535_BUS       1
#define I2C_PCA9535_ADDR      0x27
#define PCA9535_IO_MASK(a)    (1 << (a))
#define PCA9535_USER_KEY_PORT 1
#define PCA9535_USER_KEY_PIN  PCA9535_IO_MASK(7)

int pca9535_get_input_state(uchar port, uchar pin)
{
    int   dlen;
    uchar data;
    int   retval;
    ...
    if (i2c_set_bus_num(I2C_PCA9535_BUS) != 0)
    {
        return -1;
    }

    if (i2c_read(I2C_PCA9535_ADDR, port, 1, &data, dlen) != 0)
    {
        return -1;
    }
