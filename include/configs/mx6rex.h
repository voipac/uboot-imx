...
#define CONFIG_ENV_DEFAULT_UBT_FILE         "u-boot-" CONFIG_BOARD_DEFAULT_ARCH_PREFIX "-rex" CONFIG_BOARD_DEFAULT_ARCH_POSTFIX ".imx"
#define CONFIG_ENV_DEFAULT_IMG_FILE         "zImage-" CONFIG_BOARD_DEFAULT_ARCH_PREFIX "-rex" CONFIG_BOARD_DEFAULT_ARCH_POSTFIX
#define CONFIG_ENV_DEFAULT_FDT_FILE                   CONFIG_BOARD_DEFAULT_ARCH_PREFIX "-rex" CONFIG_BOARD_DEFAULT_ARCH_POSTFIX ".dtb"
#define CONFIG_ENV_DEFAULT_SCR_FILE         "boot-"   CONFIG_BOARD_DEFAULT_ARCH_PREFIX "-rex" CONFIG_BOARD_DEFAULT_ARCH_POSTFIX ".scr"
